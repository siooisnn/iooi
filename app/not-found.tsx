...
export default function NotFound() {
  return (
    <main style={{
      ...
      background: "#fdf6f0", color: "#4a3f3a", textAlign: "center", padding: "24px",
    }}>
      ...
      <p style={{ fontSize: 14, color: "#a09088" }}>小猪迷路了，回家找我吧</p>
      <Link href="/" style={{
        marginTop: 8, padding: "10px 28px", borderRadius: 999,
        background: "#c4866c", color: "#fff", textDecoration: "none", fontSize: 14,
      }}>回家</Link>
    </main>
  );
}
